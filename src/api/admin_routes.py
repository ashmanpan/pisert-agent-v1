...
class SettingsUpdateRequest(BaseModel):
    ...
    default_llm_provider: Optional[str] = Field(default=None, description="Default LLM provider (anthropic or openai)")
...
class TestKeyRequest(BaseModel):
    ...
    provider: str = Field(..., description="Provider: 'anthropic' or 'openai'")
...
async def test_api_key(request: TestKeyRequest):
    ...
    try:
        ...
        return TestKeyResponse(success=False, message=f"Key test failed: {str(e)}")
